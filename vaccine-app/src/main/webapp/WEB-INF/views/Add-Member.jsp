...
<body
 ...
 -->
	...
	<form action="addMember.vaccine" method="post" style="text-align: center;">
		...
		<p style="color: red">${validateId}</p>
		<br /> <label>Photo ID Number</label> <input name="photoIdNumber"
			type="text" placeholder="ID Number">
		<p style="color: red">${validateIdNumber}</p>
		...
		<p style="color: red">${validateType}</p>
		<br /> <label>Dose</label> <select name="dose">
			<option>Doses</option>
			<option>Dose 1</option>
			<option>Dose 2</option>
			<option>Booster Dose</option>
		</select>
		<p style="color: red">${validateDoses}</p>
